...
$query=mysqli_query($con,"insert into users(fullname,mobileNo,address,city,gender,email,password) values('$fname','$mobileNo','$address','$city','$gender','$email','$password')");
if($query)
{
