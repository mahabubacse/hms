...
$query=mysqli_query($con,"insert into blood_donor(fullname,mobileNo,address,city,gender,email,password) values('$fname','$mobileNo','$address','$city','$gender','$email','$password')");
if($query)
{
	...
	<body class="login">
		...
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.html"><h2>HMS | Blood Donor Registration</h2></a>
				</div>
				<!-- start: REGISTER BOX -->
